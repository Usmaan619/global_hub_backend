  ...
  try {
    ...
    // Define headers
     worksheet.columns = [
      ...
      { header: "Applicant First Name", key: "applicant_first_name", width: 20 },
      ...
      { header: "Co-Applicant First Name", key: "co_applicant_first_name", width: 20 },
      { header: "Co-Applicant Last Name", key: "co_applicant_last_name", width: 20 },
      ...
      { header: "Loan Officer First Name", key: "loan_officer_first_name", width: 20 },
      { header: "Loan Officer Last Name", key: "loan_officer_last_name", width: 20 },
